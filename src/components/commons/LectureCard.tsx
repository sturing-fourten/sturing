...
import { bookmark } from "../../../public/icons/icons";
import Image from "next/image";

export default function LectureCard() {
  return (
    <div className="py-[13px] px-[17px] border border-gray-300 rounded-[5px] bg-white">
      <div className="flex justify-between">
        ...
        <Image src={bookmark} alt="bookmark icon" width={24} height={24} />
      </div>
