...
export default function UserCard() {
  return (
    <>
      <article className="flex flex-col items-center gap-[9px] w-full h-[207px]">
        <section className="flex flex-col items-center gap-[8px] bg-main-100 rounded-[5px] pt-4 px-[18px] pb-4">
          <Image
