...
export default function StudyExample() {
    ...
    <>
      <button type="button" onClick={handleOpenExample}>
        <div className="flex gap-1.5 items-center">
          ...
          <p className="text-neutral-400 text-xs font-normal leading-none">스터디 소개 예시가 궁금하다면?</p>
        </div>
      </button>
      {openExample && (
        <div className="w-80 border border-neutral-300 rounded p-3">
